...
public class ItemAdminContractListAdapter extends BaseAdapter {
    ...
    public ItemAdminContractListAdapter(Context context, ArrayList<BeanContract> beans) {
    ...
    private void initializeViews(final BeanContract b, ViewHolder holder, View view) {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(context,AdminContractInfoActivity.class);
