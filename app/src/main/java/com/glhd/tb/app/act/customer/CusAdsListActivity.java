...
import com.glhd.tb.app.adapter.ItemCusAdsListAdapter;
...
public class CusAdsListActivity extends BaseActivity {
    ...
    private ItemCusAdsListAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cus_ads_list);
        ...
        adapter = new ItemCusAdsListAdapter(this, adverts);
    ...
    private void taskListHttp(int num) {
        API.myAdverts(MySp.getUser(this).getAccountId(), stationId, typeId, locationId,
