package com.glhd.tb.app.camera.activity;
...
import com.glhd.tb.app.camera.camera2.AutoFitTextureView;
import com.glhd.tb.app.camera.camera2.CaptureLayout2;
import com.glhd.tb.app.camera.camera2.CaptureListener2;
import com.glhd.tb.app.camera.camera2.CustomVideoView;
import com.glhd.tb.app.camera.camera2.util.Camera2Util;
import com.glhd.tb.app.camera.camera2.util.CompareSizeByArea;
import com.glhd.tb.app.camera.jcamera.listener.ClickListener;
import com.glhd.tb.app.camera.jcamera.listener.TypeListener;
import com.glhd.tb.app.camera.jcamera.util.ContentValue;
                ...
                switch (msg.what) {
                    case 0:
                        ...
                        try {
                            ...
                            file=compressImage(captureImage.getAbsolutePath(),picSavePath,70);
...
//                            iv_preview.setImageBitmap(bitmap);
                        ...
                        resultIntent.putExtra("imagefile",file);
