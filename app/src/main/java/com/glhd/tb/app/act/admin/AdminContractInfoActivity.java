...
public class AdminContractInfoActivity extends BaseActivity {
    ...
    private void initView() {
        ...
        payType.setText("实际收款");
        payTitle.setText("收款详情");
    ...
    private void getContractInfo() {
        ...
        API.getAdminContractInfo(bean.getId(), new MyHttp.ResultCallback<ResGetContractInfo>() {
            @Override
            ...
            public void onError(String message) {
                progressDialog.dismiss();
                MyToast.showMessage(AdminContractInfoActivity.this, "网络异常，请稍后再试");
            }
        });
    }
}
