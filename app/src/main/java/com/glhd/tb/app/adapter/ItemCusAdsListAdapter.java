...
public class ItemCusAdsListAdapter extends BaseAdapter {
    ...
    public ItemCusAdsListAdapter(Context context, ArrayList<BeanAdvert> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = layoutInflater.inflate(R.layout.item_cus_ads_list, null);
    ...
    private void initializeViews(final BeanAdvert object, ViewHolder holder, View view) {
        ...
        if (object.getInsp() != null) {

            if ("0".equals(object.getInsp().getInspStatus())) {
                holder.inspStatusIcon.setImageResource(R.drawable.zhengchang);
            } else {
                holder.inspStatusIcon.setImageResource(R.drawable.yichang);
            }
        } else {
            holder.inspStatusIcon.setImageResource(R.drawable.zhengchang);
        }
